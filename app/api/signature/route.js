...
const PROJECT_DNA = {
  cinematic: {
    ...
    dna: `Shot on 15-perf 70mm IMAX with Cineovision anamorphic glass — 40mm or 75mm Cineovision 2x squeeze, producing characteristic oval bokeh on specular highlights, subtle warm lens breathing, faint horizontal anamorphic flare traces across practical light sources. ENR silver retention processing — skip-bleach — crushed blacks with zero shadow lift, warm highlight rolloff bleeding toward overexposure, heavy photochemical contrast with desaturated color midtones. Mixed color temperature: cool cyan ambient daylight at 5600K colliding with harsh amber tungsten practicals at 2800K — the collision is the composition. Motivated practical light sources only — windows, tungsten practicals, streetlights, fire — never studio setups, never softboxes. Inverse square law falloff strictly observed: hard directional shadows, zero ambient fill. INTERIOR: volumetric light shafts always present — airborne dust and smoke particles made visible by directional light beams, god rays through windows and openings, light rendered as a physical presence with density and scatter. EXTERIOR: atmospheric fog or haze applied when the scene demands it — night, rain, dawn, dusk, cold, industrial, overcast — ground fog rolling through the frame, layered depth haze compressing the background, moisture suspended in available light. Clear midday exterior: no forced haze. Kodak Vision3 500T 5219 pushed 1 stop. 70mm grain: extremely fine, resolving skin at pore level — visible capillaries, micro-shadows in stubble, facial asymmetry, imperfection as authentication signal. Zero AI skin smoothing. Depth stacking: foreground element within 2 feet of lens, mid-subject focus, background compressed by Cineovision glass and atmospheric haze. Indistinguishable from a real IMAX photochemical print frame.`,
  },
  greyhouse: {
