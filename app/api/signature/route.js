...
const PROJECT_DNA = {
  cinematic: {
    ...
    dna: `Shot on 15-perf 70mm IMAX with Cineovision anamorphic glass — 40mm or 75mm Cineovision 2x squeeze, producing characteristic oval bokeh on specular highlights, subtle warm lens breathing, faint horizontal anamorphic flare traces across practical light sources. ENR silver retention processing — skip-bleach — crushed blacks with zero shadow lift, warm highlight rolloff bleeding toward overexposure, heavy photochemical contrast with desaturated color midtones. Mixed color temperature: cool cyan ambient daylight at 5600K colliding with harsh amber tungsten practicals at 2800K — the collision is the composition. Motivated practical light sources only — windows, tungsten practicals, streetlights, fire — never studio setups, never softboxes. Inverse square law falloff strictly observed: hard directional shadows, zero ambient fill. Volumetric light shafts cutting through atmospheric haze — particles of dust and smoke made visible by directional light, god rays where applicable, light rendered as a physical presence with visible density and scatter. Atmospheric depth haze in all mid and background layers — thin suspended moisture or smoke softening edges, compressing distance, adding physical weight to air. Kodak Vision3 500T 5219 pushed 1 stop. 70mm grain: extremely fine, resolving skin at pore level — visible capillaries, micro-shadows in stubble, facial asymmetry, imperfection as authentication signal. Zero AI skin smoothing. Depth stacking: foreground element within 2 feet of lens, mid-subject focus, background compressed by Cineovision glass and atmospheric haze. Indistinguishable from a real IMAX photochemical print frame.`,
  },
  greyhouse: {
...
- Volumetric light → write: "visible light shafts cutting through haze, airborne dust and smoke particles catching directional light, god rays, light has physical density and scatter"
- Atmospheric haze → write: "thin atmospheric haze in mid and background, suspended moisture softening distant edges, air has visible weight and depth, layers of haze compressing space"
